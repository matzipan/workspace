...
public class TDMAnchor extends TypedAtomicActor{
	...
	public void fire() throws IllegalActionException{	
		...
		if(input.hasToken(0)){  // if another node has transmitted
			...
			if(state==TDMAnchor.RX){ // if in receiving period
				...
				System.out.println(getDirector().getModelTime() + ": Recieved correctly on " + getName());
				...
				System.out.println(getDirector().getModelTime() + ": Recieved incorrectly on " + getName());
	...
	protected void sendBeacon() throws IllegalActionException {
		System.out.println(getDirector().getModelTime() + ": Sent " + syncCount + " on " + getName());
