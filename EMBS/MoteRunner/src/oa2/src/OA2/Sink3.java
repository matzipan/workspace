...
public class Sink3 {
    ...
    private static int t = 1100; // milliseconds between beacons - sample only, assessment will use unknown values 
    
    // settings for sink A
    private static byte channel = 15;
    ...
    public static void restart(byte param, long time) {
    	Logger.appendString(csr.s2b("Sent n on sink 3"));
        Logger.flush(Mote.WARN);
