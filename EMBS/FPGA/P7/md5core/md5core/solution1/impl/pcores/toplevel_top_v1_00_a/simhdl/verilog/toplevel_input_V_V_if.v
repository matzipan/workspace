...
module toplevel_input_V_V_if (
    ...
    // User signals
    output wire [31:0] input_V_V_dout,
    output wire        input_V_V_empty_n,
    input  wire        input_V_V_read
);
//------------------------Local signal-------------------
// FIFO
wire [0:0]  fifo_write;
wire [0:0]  fifo_full_n;
wire [31:0] input_V_V_din;
wire [0:0]  input_V_V_full_n;
// register slice
wire [0:0]  s_valid;
wire [0:0]  s_ready;
wire [31:0] s_data;
...
// input_V_V_fifo
toplevel_input_V_V_fifo #(
    .DATA_BITS  ( 32 ),
    .DEPTH_BITS ( 4 )
) input_V_V_fifo (
    .clk        ( ACLK ),
    .aclr       ( ~ARESETN ),
    .empty_n    ( input_V_V_empty_n ),
    .full_n     ( input_V_V_full_n ),
    .read       ( input_V_V_read ),
    .write      ( fifo_write ),
    .dout       ( input_V_V_dout ),
    .din        ( input_V_V_din )
...
assign input_V_V_din = m_data[31:0];
assign fifo_full_n   = input_V_V_full_n;
...
module toplevel_input_V_V_fifo
#(parameter
    DATA_BITS  = 8,
    DEPTH_BITS = 4
)(
...
module toplevel_input_V_V_reg_slice
#(parameter
    N = 8   // data width
) (
    // system signals
