...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("input_V_V_dout", 32, hls_in, 0, "ap_fifo", "fifo_data", 16),
	Port_Property("input_V_V_empty_n", 1, hls_in, 0, "ap_fifo", "fifo_status", 16),
	Port_Property("input_V_V_read", 1, hls_out, 0, "ap_fifo", "fifo_update", 16),
