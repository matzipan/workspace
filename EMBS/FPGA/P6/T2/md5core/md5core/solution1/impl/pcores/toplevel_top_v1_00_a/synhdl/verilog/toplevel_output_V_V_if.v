...
module toplevel_output_V_V_if (
    ...
    // User signals
    input  wire [31:0] output_V_V_din,
    output wire        output_V_V_full_n,
    input  wire        output_V_V_write
);
//------------------------Local signal-------------------
// FIFO
wire [0:0]  fifo_read;
wire [0:0]  fifo_empty_n;
wire [31:0] output_V_V_dout;
wire [0:0]  output_V_V_empty_n;
// register slice
wire [0:0]  s_valid;
wire [0:0]  s_ready;
wire [31:0] s_data;
...
// output_V_V_fifo
toplevel_output_V_V_fifo #(
    .DATA_BITS  ( 32 ),
    .DEPTH_BITS ( 4 )
) output_V_V_fifo (
    .clk        ( ACLK ),
    .aclr       ( ~ARESETN ),
    .empty_n    ( output_V_V_empty_n ),
    .full_n     ( output_V_V_full_n ),
    .read       ( fifo_read ),
    .write      ( output_V_V_write ),
    .dout       ( output_V_V_dout ),
    .din        ( output_V_V_din )
);
...
assign s_data  = {output_V_V_dout};

//+++++++++++++++++++++++++++++++++++++++++++++++++++++++

//++++++++++++++++++++++++FIFO+++++++++++++++++++++++++++
assign fifo_read    = fifo_empty_n & s_ready;
assign fifo_empty_n = output_V_V_empty_n;
...
module toplevel_output_V_V_fifo
#(parameter
    DATA_BITS  = 8,
    DEPTH_BITS = 4
)(
...
module toplevel_output_V_V_reg_slice
#(parameter
    N = 8   // data width
) (
    // system signals
