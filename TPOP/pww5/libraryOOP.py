...
class UnknownItemError(Exception):
    """Exception raised for errors in the Member BookID, e.g. not an existing BookID.
...
class InconsistentStateError(Exception):
    """Exception raised for errors of the inconsistent state between member  and  item
